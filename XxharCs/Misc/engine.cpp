...
DWORD engineDecodeDLL(BYTE* pData, char **ppszDllName, DWORD *pdwExportTable, int iSize) 
{
	...
	g_Engine.pfnConsolePrint("system offsets retrieved successfully\n");
...
void enginePatchEngine()
{
	...
	if((dwDecode & 0x0FF00000) == 0x01400000 ){ //steam
		...
		g_Engine.pfnConsolePrint("steam detected! patching...\n");
		...
		g_Engine.pfnConsolePrint("non-steam detected! patching...\n");
