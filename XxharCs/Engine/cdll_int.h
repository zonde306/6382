...
typedef struct cmd_s* (*pfnEngSrc_GetFirstCmdFunctionHandle_t)();
typedef unsigned int(*pfnEngSrc_GetNextCmdFunctionHandle_t)(struct cvar_s* cmdhandle);
typedef const char *				(*pfnEngSrc_GetCmdFunctionName_t)(struct cmd_s* cmdhandle);
